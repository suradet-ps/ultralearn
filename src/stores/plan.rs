...
impl PlanState {
  ...
  pub fn get_principle_notes(&self, plan_id: &str, principle_id: u32) -> String {
    self
      .find_progress(plan_id, principle_id)
      .map(|pp| pp.notes)
      .unwrap_or_default()
  }
  ...
  pub fn update_activity(&self, plan_id: &str, principle_id: u32, key: &str, value: ActivityValue) {
    self.mutate_principle(plan_id, principle_id, |pp| {
  ...
  pub fn get_flashcards(&self, plan_id: &str, principle_id: u32) -> Vec<Flashcard> {
    self
      .get_activity(plan_id, principle_id, "flashcards")
      .and_then(|v| match v {
  ...
  pub fn get_feedback_log(&self, plan_id: &str, principle_id: u32) -> Vec<FeedbackEntry> {
    self
      .get_activity(plan_id, principle_id, "feedbackLog")
      .and_then(|v| match v {
  ...
  pub fn add_feedback(&self, plan_id: &str, principle_id: u32, fb_type: FeedbackType, text: &str) {
  ...
  pub fn get_experiments(&self, plan_id: &str, principle_id: u32) -> Vec<Experiment> {
    self
      .get_activity(plan_id, principle_id, "experiments")
      .and_then(|v| match v {
  ...
  pub fn get_schedules(&self, plan_id: &str, principle_id: u32) -> Vec<RetentionSchedule> {
    self
      .get_activity(plan_id, principle_id, "schedules")
      .and_then(|v| match v {
